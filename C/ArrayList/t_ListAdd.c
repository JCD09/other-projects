...
int main(){
  ...
  printf("TEST ONE: testing ListAdd.\n");
  ...
  printf("TEST TWO. Testing using listAdd only into the left End of the list. ListCurr = head\n");
  printf("\tInserting elements into array list One \n");
  for (int i = 0; i < 10; i ++){
    ListFirst(listOne);
    ListAdd(listOne,&aOne[i]);
  ...
  printf("TEST THREE. Testing using listAdd only into the left End of the list. When ListCurr is out of bounds. PosIndex < 0\n");
  printf("\tInserting elements into array list One \n");
  for (int i = 0; i < 10; i ++){
    ListFirst(listOne);
    ListPrev(listOne);
  ...
  printf("TEST FIVE. Adding elemnts only to the middle of the list\n");
